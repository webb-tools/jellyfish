...
//! This module is a defines poseidon transcript.
...
impl<F> PlonkTranscript<F> for PoseidonTranscript<F>
where
    F: PoseidonParameter + SWToTEConParam,
{
        ...
        E: PairingEngine,
    {
        ...
        let hasher = PoseidonHash::default();
